  ...
  it('uses cached command/onboarding summaries but always overrides doctor summary with fresh evidence', () => {
    const cachedData: CachedIncidentStudioTelemetry = {
      ...
      releaseReadinessValidationKpiStatus: {
        workspacePath: '/tmp/demo',
        timeWindow: 'last30d',
        windowStartAt: '2026-03-26T04:00:00.000Z',
        windowEndAt: '2026-04-25T04:00:00.000Z',
        metrics: {
          releaseReadinessArtifactsExported: 2,
          goDecisionsExported: 1,
          noGoDecisionsExported: 1,
          decisionsValidated: 2,
          decisionsCorrect: 1,
          noGoDecisionsValidated: 1,
          noGoPreventedIncident: 1,
          releaseReadinessDecisionAccuracy: 50,
          noGoPreventedIncidentRate: 100,
        },
        gates: {
          telemetryEvidencePass: true,
          releaseReadinessDecisionAccuracyAvailable: true,
          noGoPreventedIncidentRateAvailable: true,
          overallPass: true,
        },
      },
      doctorSummary: {
    ...
    expect(buildIncidentStudioTelemetryFromCache(cachedData, freshDoctorSummary)).toEqual({
      ...
      studioStabilizationKpiStatus: null,
      studioReproPackKpiStatus: cachedData.studioReproPackKpiStatus,
      releaseReadinessValidationKpiStatus: cachedData.releaseReadinessValidationKpiStatus,
      verifiedOutcomeLoopStatus: {
        ...
        reusableArtifacts: {
          ...
          replayReady: 4,
          memoryEnriched: 1,
          releaseArtifactsExported: 2,
        },
        conversionRates: {
          replayToResolutionRate: 50,
          releaseDecisionAccuracy: 50,
          noGoPreventedIncidentRate: 100,
        },
        gates: {
          reproEvidencePass: false,
          releaseEvidencePass: true,
          overallPass: false,
        },
      },
      doctorSummary: {
    ...
    expect(
      buildIncidentStudioTelemetryPayload(
        ...
        },
        {
          ...
          windowEndAt: '2026-04-25T04:10:00.000Z',
          metrics: {
            releaseReadinessArtifactsExported: 3,
            goDecisionsExported: 2,
            noGoDecisionsExported: 1,
            decisionsValidated: 3,
            decisionsCorrect: 2,
            noGoDecisionsValidated: 1,
            noGoPreventedIncident: 1,
            releaseReadinessDecisionAccuracy: 66.67,
            noGoPreventedIncidentRate: 100,
          },
          gates: {
            telemetryEvidencePass: true,
      ...
      verifiedOutcomeLoopStatus: {
        ...
        reusableArtifacts: {
          ...
          replayReady: 4,
          memoryEnriched: 2,
          releaseArtifactsExported: 3,
        },
        conversionRates: {
          replayToResolutionRate: 100,
          releaseDecisionAccuracy: 66.67,
          noGoPreventedIncidentRate: 100,
        },
        gates: {
          reproEvidencePass: true,
          releaseEvidencePass: true,
          overallPass: true,
        },
      },
