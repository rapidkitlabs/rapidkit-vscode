## 🎉 First Pre-Release of RapidKit VS Code Extension

Welcome to the first pre-release of the official RapidKit extension for Visual Studio Code!

### ✨ Key Features

- 🚀 **Workspace Creation Wizard** - Interactive workspace setup
- 📦 **Project Generation** - FastAPI and NestJS project scaffolding
- 🧩 **Module Browser** - 100+ modules organized by category
- 📝 **Template Preview** - Preview templates before generation
- 💡 **IntelliSense Support** - Auto-completion for config files
- 🔧 **System Doctor** - Check system requirements
